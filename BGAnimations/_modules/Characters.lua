...
local Character = {
    ...
    Cyx = {
        ...
        zoom = .5,
        stillZoom = .4,
        attack = NewLinearFrames(0,6, 1),
        idle = NewLinearFrames(23,26,.75),
        limit = NewLinearFrames(0,6, 1.5),
        magic = NewLinearFrames(27,35,1),
        magic2 = NewLinearFrames(27,35,1),
        standby = NewLinearFrames(27,33,1.5),
        win = NewLinearFrames(4,5,.5),
        winIntro = NewLinearFrames(4,5,.5),
        still = NewLinearFrames(23,23,1),
        danger = NewLinearFrames(7,10,1),
        dead = NewLinearFrames(22,22,1),
        deadIntro = NewLinearFrames(11,21,1.5),
        stillXY = {10,-10,10,-10}, --second set is for when character is idling in Select a character
        idleXY = {0,-25},
        magic2XY = {-30,-35},
        winIntroXY = {-40,-35},
        ...
        dangerXY = {0,-35},
        attackXY = {-70,-35},
        load = THEME:GetPathG("","Characters/cyx/cyx 6x6.png"),
        icon = THEME:GetPathG("","Characters/cyx/unit_icon.png"),
        splash = THEME:GetPathG("","Characters/cyx/splash.png"),
        text = "I'm gonna take a week long break after this (actually less than 24 hours).",
        game = "ITG",
    },
}
