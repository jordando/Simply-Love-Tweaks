...
return {
	__index = {
		...
		set = function(self, info)
			...
			local toptext = self.kind ~= "" and THEME:GetString("ScreenSelectMusicExperiment", self.kind) or ""
			...
			self.bottom_text:settext(THEME:GetString(self.kind == "ChangeMode" and "ScreenSelectPlayMode" or "ScreenSelectMusicExperiment", info[2]))
		end
	}
}
